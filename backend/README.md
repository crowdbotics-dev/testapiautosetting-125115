...
## Project Structure
    ...
    ├── testapiautosetting_125115  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125115`
...
2. Clone this repo and `cd testapiautosetting_125115`
